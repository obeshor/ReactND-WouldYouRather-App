let users = {
  ...
  dustinforrest: {
    id: "dustinforrest",
    name: "Dustin Forrest",
    avatarURL: require("../images/dustinforrest.png"),
    answers: {},
  ...
  amberremy: {
    id: "amberremy",
    name: "Amber Remy",
    avatarURL: require("../images/amberremy.png"),
    answers: {
  ...
  danlester: {
    id: "danlester",
    name: "Dan Lester",
    avatarURL: require("../images/danlester.png"),
    answers: {
  ...
  ishaaqoakley: {
    id: "ishaaqoakley",
    name: "Ishaaq Oakley",
    avatarURL: require("../images/ishaaqoakley.png"),
    answers: {
  ...
  kianafuller: {
    id: "kianafuller",
    name: "Kiana Fuller",
    avatarURL: require("../images/kianafuller.png"),
    answers: {
      xj352vofupe1dqz9emx13r: "optionOne",
      vthrdm985a262al8qx3do: "optionTwo",
      "6ni6ok3ym7mf1p33lnez": "optionTwo",
  ...
  aminolson: {
    id: "aminolson",
    name: "Amin Olson",
    avatarURL: require("../images/aminolson.png"),
    answers: {
      xj352vofupe1dqz9emx13r: "optionOne",
    },
    questions: ["6ni6ok3ym7mf1p33lnez", "xj352vofupe1dqz9emx13r"],
  ...
  sofijashery: {
    id: "sofijashery",
    name: "Sofija Shery",
    avatarURL: require("../images/sofijashery.png"),
    answers: {
      "8xf0y6ziyjabvozdd253nd": "optionOne",
      loxhs1bqm25b708cmbf3g: "optionTwo",
    },
